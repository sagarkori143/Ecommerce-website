...
const Product = ({post}) => {
  ...
  return <motion.div className="relative flex border flex-col w-[200px] m-10 px-3 h-[400px] bg-white rounded-[10px] hover:scale-105 transition duration-300 hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6)] "
